...
unsigned int	FragTrap::vaulthunter_dot_exe(std::string const & target)
{
	...
	std::cout << "Над глазом " << this->getName() << " замерцали цифры и... заполучи, фашист, атаку " << attack << " ";
	...
	std::cout << "Трап-невропатолог с молоточком крошит всех! " << target << ", как тебе гидромолот в 1000 тонн?"<< std::endl;
	return (55);
}
